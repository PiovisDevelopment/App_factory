...
class HybridDiscovery:
    ...
    def __init__(
        ...
        self._prefix_pattern: Optional[re.Pattern] = None
        self._load_prefixes()
    ...
    def get_prefix_info(self, prefix: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def validate_folder_name(self, folder_name: str) -> Tuple[bool, Optional[str], List[str]]:
        """
    ...
    def parse_manifest(self, plugin_path: Path) -> Tuple[Optional[Dict[str, Any]], List[str]]:
        """
    ...
    def find_plugin(self, name: str) -> Optional[DiscoveredPlugin]:
        """
