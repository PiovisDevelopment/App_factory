...
class PluginValidator:
    ...
    def get_contract_info(self, contract: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def find_plugin_class(
        ...
        if not candidates:
            result.add_error(
                f"No plugin class found. Expected a class inheriting from PluginBase "
                f"with name ending in 'Plugin'"
            )
            return None
