...
async def test_roundtrip():
    ...
    try:
        ...
        from contracts.tts_contract import SynthesisOptions, AudioFormat
        ...
        if accuracy >= 80:
            print(f"       ✅ PASS: Good accuracy!")
        elif accuracy >= 50:
            print(f"       ⚠️  WARN: Moderate accuracy")
        else:
        ...
        print("\n📊 SUMMARY:")
        print(f"   • TTS Plugin: Kokoro TTS (kokoro>=0.9.4)")
        print(f"   • STT Plugin: Faster Whisper (faster-whisper>=1.0.0)")
        print(f"   • Both work independently (hot-swappable)")
