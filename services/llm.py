...
class LLMService:
    ...
    async def initialize(self) -> bool:
        ...
        await self._plugin.initialize({"base_url": self._base_url, "default_model": self._model, "timeout": 60})
    ...
    async def ask(
        self, question: str, model: str | None = None, temperature: float | None = None, max_tokens: int | None = None
    ) -> str:
        """
    ...
    async def chat(self, message: str | None = None, model: str | None = None, temperature: float | None = None) -> str:
        """
    ...
    def get_models(self) -> list[dict[str, Any]]:
        ...
        return [
            {"id": m.id, "name": m.name, "context_length": m.context_length, "capabilities": m.capabilities}
