...
def build_application():
    ...
    try:
        process = subprocess.Popen(
            cmd, cwd=root_path, stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True, shell=True
        )
    ...
    return {"success": True, "installer_path": found_paths[0], "all_artifacts": found_paths}
